 ...
 */
String MFRC522::PICC_DumpDetailsToSerial(Uid *uid	///< Pointer to Uid struct returned from a successful PICC_Select().
									) {
	// UID
	String resturnChar="";
	...
	for (byte i = 0; i < uid->size; i++) {
		...
		//Serial.print(uid->uidByte[i], HEX);////////////////////////////////////////////////////////////// CAMBIAR PAARA ENVAIRLO POR WIFI ///////////////////////////////---------------------------------------------------------------------------------------
		resturnChar+= String(uid->uidByte[i], HEX);
	} 
	//Serial.println();
